...
class AnalysisAgent extends baseAgent_1.BaseAgent {
    ...
    emitProgress(workflowId, agentId, message) {
        logger_1.mcpLogger.info('AnalysisAgent', message);
...
`;
        ...
        logger_1.mcpLogger.info('AnalysisAgent', `Execution completed in ${executionTimeMs}ms.`);
        ...
        try {
            ...
            logger_1.mcpLogger.error('AnalysisAgent', 'Failed to parse LLM JSON output', error);
